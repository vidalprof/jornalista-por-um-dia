...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena">' + '<div class="it" style="animation-delay:0.00s">' + '<img class="capfig" draggable="false" src="img/nt_jornaleiro.png?v=' + V + '" alt="">' + '<i class="tarja"></i>' + '' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="capfig" draggable="false" src="img/nt_golfinho.png?v=' + V + '" alt="">' + '<i class="tarja"></i>' + '' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="capfig" draggable="false" src="img/nt_beijaflor.png?v=' + V + '" alt="">' + '<i class="tarja"></i>' + '' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="capfig" draggable="false" src="img/nt_lendo.png?v=' + V + '" alt="">' + '<i class="tarja"></i>' + '' + '</div>' + '</div><div class="banca"></div>' +
